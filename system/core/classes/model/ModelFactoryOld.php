...
final class ModelFactoryOld
{
    ...
    function createFromIndexObject(object $element): Content {
        return new Content($this->createSiteObject(), $this->parseData($element));
    }
     ...
     */
    private function parseData(object $element): array {
